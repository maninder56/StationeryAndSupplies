...
-- Updating products with parent category of Desk-Accessories
...
-- INNER JOIN categories C2 
-- 	ON C.ParentID = C2.CategoryID
-- SET P.ImageUrl = 'images/products/OfficeElectronics/'
-- WHERE C2.Name = 'Office-Electronics'; 
...
-- INNER JOIN categories C2 
-- 	ON C.ParentID = C2.CategoryID
-- SET P.ImageUrl = CONCAT(P.ImageUrl, 'Sketchbooks/')
-- WHERE C.Name = 'Sketchbooks'; 
-- 
...
-- INNER JOIN categories C2 
-- 	ON C.ParentID = C2.CategoryID 
-- SET P.ImageUrl = CONCAT(P.ImageUrl, REPLACE(P.Name, ' ', ''), '.jpg')
-- WHERE C2.Name = 'Office-Electronics'
-- 	OR C2.Name = 'Desk-Accessories'
-- 	OR C2.Name = 'Art-Supplies'; 
...
INNER JOIN categories C2 
	ON C.ParentID = C2.CategoryID 
WHERE C2.Name = 'Art-Supplies'
ORDER BY C2.Name DESC, C.Name, P.ProductID; 
